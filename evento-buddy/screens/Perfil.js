...
const styles = StyleSheet.create({
  ...
  avatar: {
    ...
    borderRadius: 60,
    marginBottom: 16,
    backgroundColor: "#B497D6", // fundo roxo claro no avatar
  },
  name: {
    fontSize: 22,
    fontWeight: "bold",
    color: "#8A5FBF", // nome roxo escuro
  },
  email: {
    fontSize: 16,
    color: "#666",
  ...
  action: {
    width: "100%",
    backgroundColor: "", // roxo bem claro para caixas
    padding: 14,
    borderRadius: 8,
    marginBottom: 12,
  },
  actionText: {
    fontSize: 16,
    color: "#4A3C6A", // roxo escuro para texto das ações
  },
  logoutButton: {
    marginTop: 40,
    backgroundColor: "#8A5FBF", // vermelho permanece
    padding: 14,
    borderRadius: 8,
    width: "100%",
    alignItems: "center",
